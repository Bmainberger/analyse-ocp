...
with cp1:
    statut_pro = st.selectbox("Statut Professionnel", ["Salarié", "TNS / Libéral", "Dirigeant (Gérant/Président)", "Fonctionnaire", "Retraité", "Sans activité"])
        ...
        with st.expander(f"Placement Collectif n°{j+1}", expanded=True):
            ...
            with c3:
                ...
                if val_estim > 0:
                    ...
                    st.metric("Rendement estimé", f"{rendement:.2f} %")
